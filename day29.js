...
const users = [
 ...
 //using the reduce method to return the sum of the ages forund in the obj users
const users = [
    { name: 'John', age: 34 },
    { name: 'Amy', age: 20 },
    { name: 'camperCat', age: 10 }
...
const watchList = [
  ...
  function getRating(watchList) {
    ...
    const filteredList = watchList.filter(movie => movie.Director == "Christopher Nolan").map(movie => ({
    ...
    const sumFilteredList = filteredList.reduce((sum, user) =>
    sum + parseFloat(user.Rating), 0)
  
    //console.log(sumFilteredList); 
  ...
  averageRating = sumFilteredList/filteredList.length; 
